...
5. Try to run the program from the terminal.

In your PDF submission, write:

- The terminal command you used to create or open the file in Vim.
- The terminal command you used to run the program.
- The complete message or output displayed in the terminal.
...
- **Customer's name:** Sara
- **Drink:** Matcha Latte
- **Price before tax:** $7.00

Run the modified program and confirm that it produces the requested output.

## Submission Instructions

Submit the following files to **Activity 1 on Sakai**:
...
Make sure both files include your name and are uploaded before you submit the activity.
